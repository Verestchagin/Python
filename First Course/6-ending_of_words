...
что вы не рассмотрели какой-то из случаев входных данных (число программистов 0 \le n \le 10000≤n≤1000). Обязательно проверяйте свои
...
elif o == 0 or o == 5 or o == 6 or o == 7 or o == 8 or o == 9:
    print (a, 'программистов')
elif o == 1:
    print(a, 'программист')
